...
int main()
{
    string names_file = "/home/cicv/slam/darknet/data/coco.names";
    String model_def = "/home/cicv/slam/darknet/cfg/yolov3.cfg";
    String weights = "/home/cicv/slam/darknet/yolov3.weights";
